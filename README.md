...
[![version](https://img.shields.io/badge/release-v0.6.2-success)](https://github.com/udibo/test_suite/tree/v0.6.2)
[![deno doc](https://img.shields.io/badge/deno-doc-success?logo=deno)](https://doc.deno.land/https/deno.land/x/test_suite@v0.6.2/mod.ts)
...
import { TestSuite, test } from "https://deno.land/x/test_suite@v0.6.2/mod.ts";
// Import from GitHub
import { TestSuite, test } "https://raw.githubusercontent.com/udibo/test_suite/v0.6.2/mod.ts";
```
...
See [deno docs](https://doc.deno.land/https/deno.land/x/test_suite@v0.6.2/mod.ts) for more information.
